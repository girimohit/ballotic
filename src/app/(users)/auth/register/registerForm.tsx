    ...
    return (
        <>
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 items-center mt-16 p-11 border border-white rounded-2xl ">
                ...
                <input type="email" name="email" placeholder="Email" className="bg-transparent border-b border-gray-300 focus:border-none p-2" required />
                <input type="text" name="role" placeholder="Role" className="bg-transparent border-b border-gray-300 focus:border-none p-2" required />
                <input type="number" name="ward_number" placeholder="ward_number" className="bg-transparent border-b border-gray-300 focus:border-none p-2" required />
                <input type="number" name="district_id" placeholder="District ID" className="bg-transparent border-b border-gray-300 focus:border-none p-2" required />
