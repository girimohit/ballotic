        ...
        <>
            {election &&
                election.map((i) => (
                    <div
                        key={i.election_id}
                        className="flex flex-col bg-gray-200 dark:bg-black rounded-3xl md:p-8 md:pb-10 p-5  w-[85%] min-h-fit md:w-[48%]  overflow-hidden my-8 border border-gray-300 dark:border-gray-600 relative drop-shadow-[0_5px_5px_rgba(255,255,255,0.25)]"
                    >
                        {i.current_status ? (
                            <span className="absolute top-0 left-0 p-2 px-4 text-sm  bg-green-600 rounded-br-3xl">
                                Live
                            </span>
                        ) : (
                        ...
                        <div className=" flex justify-end md:px-5">
                            ...
                            <div className=" flex items-center gap-4">
                                <VotePopup
                                    ...
                                    electionID={i.election_id}
                                    isElectionLive={i.current_status}
                                />
                            </div>
                        </div>
                    </div>
